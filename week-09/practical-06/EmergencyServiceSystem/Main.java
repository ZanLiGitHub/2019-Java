...
public class Main {
    ...
    public static void initializeSystem(ServiceCenter serviceCenter){
        ...
        for(int i=0; i<name.length; i++){
            serviceCenter.addPatientIntoList(name[i], phoneNumbers[i], triageLevel[i], location[i], id[i]);
        }
    ...
    public static boolean performAction(ServiceCenter serviceCenter, int _option, Scanner inputScan){
        ...
        switch(_option){
            case 1:
                ...
                String id = getInput(inputScan, "Please enter the id of patient: ");
                serviceCenter.addPatientIntoList(name, phoneNumber, Integer.parseInt(triageLevel), location, Integer.parseInt(id));
                waitInput(inputScan);
                break;
            case 2:
                clearScreen();
            ...
            case 0:
                ...
                return false;
            default :
                System.out.println("Your input is illegal, the system only accept (1-5) as legal number");
