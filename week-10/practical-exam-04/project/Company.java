...
public class Company{
	...
	public void getMaxEmp(){
		return maxEmp;
	}
	public void getCurStaff(){
		return curStaff;
	}
	...
	Company(){
		...
		staff[0] = new Employee("Mark",30,40,50.0f,10);
		staff[1] = new Employee("Bela",19,40,60.0f,1);
		staff[2] = new Employee("Vicky",19,15,70.0f,10);
		staff[3] = new Employee("Jordan",55,15,40.0f,5);
		staff[4] = new Employee("Mary",27,10,35.0f,1);
		staff[5] = new Employee("JustinBieber",14,20,5000.0f,1);
		staff[6] = new Employee("Becky",18,8,20.0f,2);
		staff[7] = new Employee("Bruno",24,8,50.0f,4);
